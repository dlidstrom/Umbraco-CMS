...
public class PostgresqlPreferDeferredTransactionsConnection : DbConnection
{
    private readonly NpgsqlConnection _inner;

    public PostgresqlPreferDeferredTransactionsConnection(NpgsqlConnection inner) => _inner = inner;
    ...
    private class CommandWrapper : DbCommand
    {
        ...
        protected override DbConnection? DbConnection
        {
            ...
            set => _inner.Connection = (value as PostgresqlPreferDeferredTransactionsConnection)?._inner;
        }
